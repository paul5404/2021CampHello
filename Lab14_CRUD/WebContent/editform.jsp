...
%>
<%@page import="com.lab14.bean.BookVO,com.lab14.dao.BookDao"%>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
	...
	<form action="edit_ok.jsp" method="post">
		...
		<div class="form-horizontal">
			...
			<div class="form-group row">
				...
				<div class="col-sm-7">
					<input autofocus class="form-control" type="text" name="title" value="<%=vo.getTitle() %>">
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-sm-7">
					<input class="form-control" type="text" name="writer" value="<%=vo.getWriter() %>">
				</div>
			</div>
